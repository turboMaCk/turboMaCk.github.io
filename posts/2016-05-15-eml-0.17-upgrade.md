...
It has been few month since I’ve started to learn [Elm programming language](http://elm-lang.org/).
...
Learn a little bit of learning syntax, core functions, types, Signals, Effects, Mailboxes and [Elm architecture](https://github.com/evancz/elm-architecture-tutorial).
...
It looks like all [packages](http://package.elm-lang.org/) it needs are ready for 0.17. Plan was made and yesterday I finally found some time to upgrade it to 0.17.
