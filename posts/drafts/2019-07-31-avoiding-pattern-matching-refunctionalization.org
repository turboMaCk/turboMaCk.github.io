...
establishes good bases and vocabulary for talking this relationship.

The talk also describes CSP which I in fact wanted to talk about in the last part
of my "Deeper Dive To (Tail) Recursion" series of write-ups which I haven't finished
...
I haven't planned to write a post about this in this shape though until
another friend of mine asked me if I can try to write something about the topic we've discussed
...
write-up on the Martin's article is that this will offer reader to see
two opposite views the same implementation.
